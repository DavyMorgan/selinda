...
#data_test_name = ['bluthgen_et_al_2004_graph_animal', 'cle_matr_graph_animal']
#data_test_name = ['synthetic_ER-uniform_node-100_degree-20_weight-1_1']
data_test_name = [f'synthetic_n_degree-6_seed-{i}' for i in range (30)]
