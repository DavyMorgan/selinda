 ...
 */
    ...
    __pyx_t_5 = -1;
    if (__pyx_t_4 < 0) {
      __pyx_t_4 += __pyx_v_edges_to.shape[0];
      if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 0;
    } else if (unlikely(__pyx_t_4 >= __pyx_v_edges_to.shape[0])) __pyx_t_5 = 0;
    if (unlikely(__pyx_t_5 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_5);
      __PYX_ERR(0, 74, __pyx_L1_error)
    }
    (__pyx_v_cint_edges_to[__pyx_v_i]) = (*((int *) ( /* dim=0 */ (__pyx_v_edges_to.data + __pyx_t_4 * __pyx_v_edges_to.strides[0]) )));
  }
 ...
 */
  try {
    __pyx_t_6 = new Graph(__pyx_v__num_nodes, __pyx_v__num_edges, (&(__pyx_v_cint_edges_from[0])), (&(__pyx_v_cint_edges_to[0])));
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 75, __pyx_L1_error)
  }
  __pyx_v_self->inner_graph = std::shared_ptr<Graph> (__pyx_t_6);
