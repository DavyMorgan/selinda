...
int NODE_NUM, TARGET_SIZE;
char* FILE_NET;  // input format of each line: id1 id2
char* FILE_ID;  // output the id of the removed nodes in order
//const char* FILE_NET = "thirdparty/GND/temp_input.txt";  // input format of each line: id1 id2
//const char* FILE_ID = "thirdparty/GND/temp_output.txt";  // output the id of the removed nodes in order
//const char* FILE_NET = "temp_input.txt";  // input format of each line: id1 id2
//const char* FILE_ID = "temp_output.txt";  // output the id of the removed nodes in order
//const char* FILE_PLOT = "Plot_GND.txt";   // format of each line: gcc removed_cost removed_nodes
...
int main(int argc, char *argv[])
{
    ...
    NODE_NUM = std::stoi(argv[1]);                // the number of nodes
    FILE_NET = argv[2];
    FILE_ID = argv[3];
    TARGET_SIZE = 2; // If the gcc size is smaller than TARGET_SIZE, the dismantling will stop. Default value can be 0.01*NODE_NUM  OR  1000
